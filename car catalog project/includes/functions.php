...
error_reporting(0);
	...
	function welcomeMessage()
	{
		echo '<div class="welcome">';
			...
			echo '<p>Hopefully you can find something that piques your interest! You can have a look at our products by clicking <a href="catalog.php">here.</a></p>';
		echo '</div>';
	}
	...
	function cartTable()
	{
		if (isset($_SESSION['id']))
		{
			...
			$tableOpen = '<table><tr><th>Product Name</th><th>Unit Price</th><th>Quantity</th><th>Total Price</th></tr>';
			$tableGuts = '';
			$tableClose = '</table>';
			$total = 0;
			...
			for ($x = 0; $x < sizeof($_SESSION['id']); $x++)
			{
				if($_SESSION['qty'][$x] != 0)
				{
					...
					$tableGuts .= '<td><input name="qty'.$x.'" type="text" value="'.$_SESSION['qty'][$x].'"></td>';
