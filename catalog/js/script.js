...
/*Creates error messages in real time as the user types in their password in the account creation page.
Once user creates an acceptable password, submit button becomes available to click.*/
